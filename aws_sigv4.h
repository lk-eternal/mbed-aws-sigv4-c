...
typedef struct aws_sigv4_params_s {
  ...
  /* x-amz-content-sha256 header value string sha256(Content) or "UNSIGNED-PAYLOAD" */
  aws_sigv4_str_t x_amz_content_sha256;
  /* x-amz-date header value in ISO8601 format */
  aws_sigv4_str_t x_amz_date;
  /* x-amz-decoded-content-length header value string Content-Length */
  aws_sigv4_str_t x_amz_decoded_content_length;
 ...
 * @param[in] x_amz_content_sha256          HTTP x-amz-content-sha256 header value string sha256(Content) or "UNSIGNED-PAYLOAD"
 * @param[in] x_amz_date                    HTTP x-amz-date header value string in ISO8601 format
 * @param[in] x_amz_decoded_content_length  HTTP x-amz-decoded-content-length header value string Content-Length
